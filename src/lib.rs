...
pub fn sync(_attr: TokenStream, unparsed_input: TokenStream) -> TokenStream {
    ...
    let track_attr = serialization.to_string();
    ...
    let implementation = quote! {
        ...
        legion_sync::register_component_type!(#name, #serialization);
    };
